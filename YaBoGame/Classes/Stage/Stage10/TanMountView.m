...
- (void)peelComparativeSoil {
    ...
    [[WNXSoundToolManager sharedSoundToolManager] patWorthyLiberty:kSoundRollingName2];
...
- (void)setAnimFinishCount:(int)animFinishCount {
    ...
    if (_animFinishCount == 2) {
        [[WNXSoundToolManager sharedSoundToolManager] patWorthyLiberty:kSoundJackpotStop];
