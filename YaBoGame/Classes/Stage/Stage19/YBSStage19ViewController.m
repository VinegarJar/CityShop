...
@interface YBSStage19ViewController ()
{
    int _index;
    BOOL _hasFish;
    BOOL _playAgain;
}
@property (nonatomic, strong) YBSStage19FishView *fishView;
...
@end
@implementation YBSStage19ViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    [self buildStageInfo];
}
...
- (void)buildFishView {
    self.fishView = [[YBSStage19FishView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHeight - self.redButton.frame.size.height)];
