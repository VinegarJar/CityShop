...
@interface ComputeDirectionExcessiveView ()
{
    int _index;
    int _number1;
    int _number2;
...
- (void)glitterOntoUptodateChild:(int)number1 secoundDiceNumber:(int)number2 thridDiceNumber:(int)number3 shakeDuration:(NSInteger)duration {
    ...
    _number3 = number3;
    _duration = duration;
    [self flourishPastMultiplePhonetics];
}
- (void)flourishPastMultiplePhonetics {
