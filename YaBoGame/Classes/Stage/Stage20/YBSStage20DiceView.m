#import "YBSStage20DiceView.h"
#import "YBSDiceView.h"
@interface YBSStage20DiceView ()
{
    int _count;
    int _diceView1Num1;
    int _diceView1Num2;
...
@property (nonatomic, strong) YBSDiceView *dice1;
@property (nonatomic, strong) YBSDiceView *dice2;
@property (nonatomic, strong) YBSDiceView *dice3;
@end
@implementation YBSStage20DiceView
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        self.dice1 = [YBSDiceView viewFromNib];
        [self addSubview:self.dice1];
        self.dice2 = [YBSDiceView viewFromNib];
        self.dice2.frame = CGRectMake(ScreenWidth / 3, 0, ScreenWidth / 3, self.dice2.frame.size.height);
        [self addSubview:self.dice2];
        self.dice3 = [YBSDiceView viewFromNib];
