...
@interface YBSStage20ViewController ()
{
    int _maxIndex;
    int _timeCount;
    int _diceCount;
...
@property (nonatomic, strong) YBSStage20DiceView *diceView;
@property (nonatomic, assign) NSInteger allScore;
@property (nonatomic, strong) CADisplayLink *timer;
@end
@implementation YBSStage20ViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    [self buildStageInfo];
}
...
- (void)buildDiceView {
    self.diceView = [[YBSStage20DiceView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHeight - self.redButton.frame.size.height)];
