...
@property (nonatomic, strong) YBSBobmView *bobmView1;
@property (nonatomic, strong) YBSBobmView *bobmView2;
@property (nonatomic, strong) YBSBobmView *bobmView3;
@property (nonatomic, strong) CADisplayLink *timer;
@property (nonatomic, strong) YBSStage09ResultView *resultView1;
@property (nonatomic, strong) YBSStage09ResultView *resultView2;
@property (nonatomic, strong) YBSStage09ResultView *resultView3;
@end
@implementation YBSStage09BobmView
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        __weak typeof(self) weakSelf = self;
        self.bobmView1 = [YBSBobmView viewFromNib];
        ...
        self.bobmView2 = [YBSBobmView viewFromNib];
        ...
        self.bobmView3 = [YBSBobmView viewFromNib];
        ...
        self.resultView1 = [YBSStage09ResultView viewFromNib];
