...
@interface YBSStage18PokerView ()
@property (nonatomic, strong) NSMutableArray *pokerArr;
@end
@implementation YBSStage18PokerView
{
    BOOL _same1;
    BOOL _same2;
    BOOL _same3;
...
- (BOOL)showPokerView {
    ...
    _selectSame2 = NO;
    _selectSame3 = NO;
    YBSPokerView *leftPokerView = [YBSPokerView viewFromNib];
    leftPokerView.frame = kLeftPokerViewFrame;
    [self addSubview:leftPokerView];
    YBSPokerView *middlePokerView = [YBSPokerView viewFromNib];
    middlePokerView.frame = kMiddlePokerViewFrame;
    [self addSubview:middlePokerView];
    YBSPokerView *rightPokerView = [YBSPokerView viewFromNib];
