...
@interface YBSStage15View ()
{
    int _count;
    CGFloat _rowHeight;
    int _rowCount;
    WNXStage15PeoplePositonType _willJumpToType;
    YBSStage15RowView *_tmpNextRow;
...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHeight - ScreenWidth / 3)]) {
        ...
        YBSStage15RowView *row = [YBSStage15RowView viewFromNib];
        ...
        YBSStage15RowView *row2 = [YBSStage15RowView viewFromNib];
        ...
        YBSStage15RowView *row3 = [YBSStage15RowView viewFromNib];
...
- (BOOL)jumpToNextRowWithIndex:(int)index {
    BOOL result = NO;
    YBSStage15RowView *nextRow = (YBSStage15RowView *)[self viewWithTag:1000 + _rowCount];
    _tmpNextRow = nextRow;
...
- (void)showNextRow {
    for (YBSStage15RowView *row in self.rowArray) {
