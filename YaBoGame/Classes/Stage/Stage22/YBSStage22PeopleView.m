...
@interface YBSStage22PeopleView ()
{
    int _clickCount;
    BOOL _isReomve;
}
...
@property (nonatomic, strong) YBSStrokeLabel *countLabel;
@property (nonatomic, strong) UIImageView *fartIV;
@property (nonatomic, strong) NSMutableArray *numArr;
@end
@implementation YBSStage22PeopleView
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHeight - ScreenWidth / 3)]) {
        ...
        self.countLabel = [[YBSStrokeLabel alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth / 3, 50)];
