...
@property (nonatomic, strong) EmbarrassHoarseEndurance *countLabel;
@property (nonatomic, strong) UIImageView *fartIV;
@property (nonatomic, strong) NSMutableArray *numArr;
@end
@implementation TugOddView
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHeight - ScreenWidth / 3)]) {
        ...
        self.countLabel = [[EmbarrassHoarseEndurance alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth / 3, 50)];
...
- (BOOL)besidesSpritualInsurance:(int)index {
    BOOL result;
    if (self.numArr.count > 0) {
