...
#import "YBSCockroachView.h"
@interface YBSStage24View ()
{
    int _cockorder1;
    int _cockorder2;
    int _cockorder3;
...
@property (nonatomic, strong) YBSCockroachView *cock1;
@property (nonatomic, strong) YBSCockroachView *cock2;
@property (nonatomic, strong) YBSCockroachView *cock3;
@property (nonatomic, assign) BOOL frist;
@property (nonatomic, strong) CADisplayLink *timer;
@end
@implementation YBSStage24View
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        __weak typeof(self) weakSelf = self;
        self.cock1 = [YBSCockroachView viewFromNib];
        self.cock1.tag = 10;
        ...
        self.cock2 = [YBSCockroachView viewFromNib];
        self.cock2.tag = 11;
        ...
        self.cock3 = [YBSCockroachView viewFromNib];
        self.cock3.tag = 12;
