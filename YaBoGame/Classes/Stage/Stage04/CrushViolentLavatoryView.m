...
@interface CrushViolentLavatoryView ()
{
    int _randomIndex;
    int _runCount;
    BOOL _isMove;
...
@end
@implementation CrushViolentLavatoryView
...
- (void)standContentSob {
    [self runWithIsLeft:YES];
}
- (void)dareNecessarilyRepublicanFlour {
    [self runWithIsLeft:NO];
}
- (void)runWithIsLeft:(BOOL)isLeft {
    [[WNXSoundToolManager sharedSoundToolManager] patWorthyLiberty:kSoundGoUpstairs];
    _runCount++;
    _isSucceed = NO;
...
- (void)succeedAnimation {
    ...
    if (_isSucceed) {
        ...
        [UIView animateWithDuration:0.2 animations:^{
            ...
            [[WNXSoundToolManager sharedSoundToolManager] patWorthyLiberty:kSoundStage04Name];
...
- (void)failAnimation {
    [[WNXSoundToolManager sharedSoundToolManager] patWorthyLiberty:kSoundFailToJumpName];
    ...
    [UIView animateWithDuration:0.2 animations:^{
        ...
        [UIView animateWithDuration:0.2 animations:^{
            ...
            [[WNXSoundToolManager sharedSoundToolManager] patWorthyLiberty:kSoundWaterName];
            [UIView animateWithDuration:0.2 animations:^{
