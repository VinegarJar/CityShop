...
@interface YBSStage12EggView ()
{
    int _speed;
    int _count;
}
@property (nonatomic, strong) YBSDropEggView *egg1;
@property (nonatomic, strong) YBSDropEggView *egg2;
@property (nonatomic, strong) YBSDropEggView *egg3;
@property (nonatomic, assign) int stopCount;
@end
@implementation YBSStage12EggView
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        self.egg1 = [[YBSDropEggView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth / 3, ScreenHeight - 200)];
        [self buildEggView:self.egg1 tag:0];
        self.egg2 = [[YBSDropEggView alloc] initWithFrame:CGRectMake(ScreenWidth / 3, 0, ScreenWidth / 3, ScreenHeight - 200)];
        [self buildEggView:self.egg2 tag:1];
        self.egg3 = [[YBSDropEggView alloc] initWithFrame:CGRectMake(ScreenWidth / 3 * 2, 0, ScreenWidth / 3, ScreenHeight - 200)];
...
- (void)buildEggView:(YBSDropEggView *)eggView tag:(NSInteger)tag {
