...
#import "OclockVisibleBookmarkView.h"
#import "CopyConnectionAdditionalView.h"
@interface NeedConservativeMinorView ()
{
...
@end
@implementation NeedConservativeMinorView
...
- (void)strengthenConsciousnessHateful:(int)speed {
    if (self.timer) {
        [self.timer invalidate];
        self.timer = nil;
    }
...
- (NSInteger)showHandAndResult {
    ...
    [[WNXSoundToolManager sharedSoundToolManager] patWorthyLiberty:kSoundEggYearName];
    ...
    CopyConnectionAdditionalView *resultView = [[CopyConnectionAdditionalView alloc] initWithFrame:CGRectMake(0, CGRectGetMinY(whiteView.frame) - 150, ScreenWidth / 3, 120)];
    resultView.alpha = 0;
    ...
    [resultView wagDownstairsWillingEnterprise:stateType score:scroe];
