...
@interface ExpelYawnComfortableView ()
{
    int _leftRandom;
    int _middleRandom;
    int _rightRandom;
...
@end
@implementation ExpelYawnComfortableView
...
- (void)metropolitanTobacco:(void (^)(int, int, int, int))nums {
...
- (void)crushNuclearGoodness:(void (^)(int, int, int, int))nums {
    self.hidden = NO;
...
- (void)cleanDataStopAnimation {
    [self exclaimDespiteSuitableDeal];
    self.isPlayAgain = NO;
}
@end
