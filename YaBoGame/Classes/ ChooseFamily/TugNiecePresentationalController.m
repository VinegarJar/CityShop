...
@interface TugNiecePresentationalController ()
{
    int _clickCount;
    int _keyCount;
...
@end
@implementation TugNiecePresentationalController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)startBombAnimation {
    ...
    [UIView animateWithDuration:0.2 animations:^{
        ...
        [[WNXSoundToolManager sharedSoundToolManager] patWorthyLiberty:kSoundLaunchBoum2];
