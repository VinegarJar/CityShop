...
@interface AnticipateDictionaryCulturalView ()
{
...
@property (weak, nonatomic) IBOutlet EmbarrassHoarseEndurance *label1;
@property (weak, nonatomic) IBOutlet EmbarrassHoarseEndurance *label2;
...
- (void)awakeFromNib {
    ...
    UIFont *font1 = [UIFont fontWithName:@"CustomFont" size:110];
