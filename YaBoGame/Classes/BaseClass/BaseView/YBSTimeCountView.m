...
@property (weak, nonatomic) IBOutlet YBSStrokeLabel *label1;
@property (weak, nonatomic) IBOutlet YBSStrokeLabel *label2;
@property (weak, nonatomic) IBOutlet UIImageView *backgroundImageView;
@property (nonatomic, strong) CADisplayLink *timer;
@end
@implementation YBSTimeCountView
- (void)awakeFromNib {
