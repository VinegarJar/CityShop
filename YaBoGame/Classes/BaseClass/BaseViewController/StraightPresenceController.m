...
@interface StraightPresenceController ()
@end
@implementation StraightPresenceController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)repentLover:(BOOL)isActivate {
...
- (void) resignAboveDrought:(UIImage *)image contenEdgeInsets:(UIEdgeInsets)insets {
    for (UIButton *btn in self.buttons) {
        [btn setImage:image forState:UIControlStateNormal];
        btn.contentEdgeInsets = insets;
    }
}
- (void) resignAboveDroughtNames:(NSArray *)buttonImageNames {
