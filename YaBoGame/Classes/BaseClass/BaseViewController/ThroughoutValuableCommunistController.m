...
@interface ThroughoutValuableCommunistController ()
{
...
@end
@implementation ThroughoutValuableCommunistController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (IBAction)buttonClick:(UIButton *)sender {
    ...
    switch (sender.tag) {
        ...
        case 21:
        {
            ...
            ExtendDateOrganicController *settingVC = [sb instantiateViewControllerWithIdentifier:@"settingVC"];
