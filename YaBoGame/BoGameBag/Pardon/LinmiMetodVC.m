...
- (BOOL)reasonAsLeather {
    ...
    _selectSame2 = NO;
    _selectSame3 = NO;
    BubblePerChampionshipView *leftPokerView = [BubblePerChampionshipView viewFromNib];
    leftPokerView.frame = kLeftPokerViewFrame;
    [self addSubview:leftPokerView];
    BubblePerChampionshipView *middlePokerView = [BubblePerChampionshipView viewFromNib];
    middlePokerView.frame = kMiddlePokerViewFrame;
    [self addSubview:middlePokerView];
    BubblePerChampionshipView *rightPokerView = [BubblePerChampionshipView viewFromNib];
    ...
    [[YaBoOrgyTool sharedSoundToolManager] patWorthyLiberty:YaSoundDealName];
    ...
    [leftPokerView joinPerhapsInstantProfit:leftType number:leftPokerNum];
    [middlePokerView joinPerhapsInstantProfit:middleType number:middlePokerNum];
    [rightPokerView joinPerhapsInstantProfit:rightType number:rightPokerNum];
    return result;
}
